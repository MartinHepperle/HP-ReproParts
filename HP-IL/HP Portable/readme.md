...
This script creates code to load the binary from DATA statements and appends an example program for talking to a digital voltmeter. The loader also saves the machine code as a binary file which can later be loaded with BLOAD to speed the loading proces up.
